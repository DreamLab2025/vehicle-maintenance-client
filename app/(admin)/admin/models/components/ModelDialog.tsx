...
import { CreateModelRequest, TransmissionType, VehicleModel, VehicleModelVariant } from "@/lib/api/services/fetchModel";
  ...
  useEffect(() => {
    if (isEditMode && model) {
      reset({
        ...
        images:
          (model as VehicleModel & { variants: VehicleModelVariant[] }).variants?.map((v: VehicleModelVariant) => ({
            color: v.color,
            hexCode: v.hexCode,
            imageUrl: v.imageUrl,
          })) || [],
