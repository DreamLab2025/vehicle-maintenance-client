      ...
      <div className="flex flex-col md:flex-row md:items-center gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={() =>
              toast.message(
                "Users API hiện chỉ hỗ trợ GET. Chưa có endpoint tạo user cho Admin.",
              )
            }
          >
...
function UserDetailDialog(props: {
  ...
  const { user, isLoading, isFetching, isError, refetch } = useUserById(
    userId ?? "",
    open && !!userId,
  );
          ...
          {isError ? (
            ...
            <div className="space-y-3">
              ...
              <div className="text-xs text-slate-500">
                Lưu ý: API Users hiện chỉ hỗ trợ GET, chưa có action
                update/ban/role.
              </div>
            </div>
          )}
...
export default function UsersPage() {
  ...
  const { users, metadata, isLoading, isFetching, isError, refetch } = useUsers(
    params,
    true,
  );
