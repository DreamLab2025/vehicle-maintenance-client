...
import { DesktopVehicleColumn } from "./DesktopVehicleColumn";
import { DesktopCenterPanel } from "./DesktopCenterPanel";
...
export function HomeDesktopView() {
  ...
  if (isLoading) {
    return (
      <div className="flex h-full min-h-0 bg-neutral-100 dark:bg-neutral-950">
  ...
  return (
    <div className="flex h-full min-h-0 bg-[#F9F8F6] dark:bg-neutral-950">
      <DesktopSidebar />
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        <DesktopMainHeader currentVehicle={currentVehicle} />
        <div className="flex min-h-0 flex-1 overflow-hidden m-4 gap-4">
